...
func (l *UpdateEmStockBasicInfoLogic) UpdateEmStockBasicInfo(req *types.EmStockBasicInfoInfo) (resp *types.BaseMsgResp, err error) {
	data, err := l.svcCtx.EfinanceRpc.UpdateEmStockBasicInfo(l.ctx,
