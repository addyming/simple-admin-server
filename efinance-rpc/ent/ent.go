...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			emfinancialindicator.Table: emfinancialindicator.ValidColumn,
			emstockbasicinfo.Table:     emstockbasicinfo.ValidColumn,
			emstockwatch.Table:         emstockwatch.ValidColumn,
		})
	})
